 ...
 * @author philipe.gama
 */
public class TelaListaDisciplina extends javax.swing.JFrame {
    private ArrayList<Disciplina> listaBeans;
    private TelaDisciplinaOfertada view;
    /**
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        Disciplina disciplina = listaBeans.get(index);
        view.setTxtDisciplina(disciplina.getSigla());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaDisciplina().setVisible(true);
            }
        });
    }
        ...
        try {
                ...
                for (Disciplina bean : listaBeans) {
    ...
    public void setTelaDisciplinaOfertada(TelaDisciplinaOfertada view){
       this.view = view;
    }
